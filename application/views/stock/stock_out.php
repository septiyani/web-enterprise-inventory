	...
	<div class="content-wrapper">
		...
		<section class="content-header">
			<h1>
				<?php echo lang('stock_out');?>
				<small><?php echo lang('stock_out_label');?></small>
			</h1>
			<ol class="breadcrumb">
				<li><i class="fa fa-archive"></i> <a href="<?php echo base_url('auth') ?>"><?php echo lang('stock_out_heading');?></a></li>
				<li class="active"><?php echo lang('stock_out'); ?></li>
			</ol>
		</section>
				...
				<div class="box-body">
					...
					<?php echo form_open("stock/update", array('class' => 'form form-horizontal', 'autocomplete' => 'off'));?>
						...
						<div class="form-group">
							<?php echo lang('stock_out_item_label', 'item', array('class' => 'control-label col-md-3'));?>
							<div class="col-md-7">
						...
						<div class="form-group">
							<?php echo lang('stock_out_qty_label', 'qty', array('class' => 'control-label col-md-3'));?>
							<div class="col-md-7">
